...
public class Rabies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i = 0; i< com.vinay.expandablelist.Model.MyData1.titleArray.length; i++)
        {
            dataModels.add(new com.vinay.expandablelist.Model.DataModel(
                    com.vinay.expandablelist.Model.MyData1.titleArray[i],
                    com.vinay.expandablelist.Model.MyData1.Rabies[i],
                    com.vinay.expandablelist.Model.MyData1.id[i]
            ));
        }
